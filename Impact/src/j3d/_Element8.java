...
public class _Element8 extends _Element implements Serializable{
  public _Node node1,node2,node3,node4,node5,node6,node7,node8,node1_tmp,node2_tmp,node3_tmp,node4_tmp,node5_tmp,node6_tmp,node7_tmp,node8_tmp;
  ...
  public _Element8(_Node n1, _Node n2, _Node n3, _Node n4, _Node n5, _Node n6, _Node n7, _Node n8, Material m){
    node1=n1; node2=n2; node3=n3; node4=n4; node5=n5; node6=n6; node7=n7; node8=n8; material=m;
  }
  public _Element8(_Node n1, _Node n2, _Node n3, _Node n4, _Node n5, _Node n6, _Node n7, _Node n8){
  ...
  public String writeObject() {
    ...
    st+=" \tnodes = ["+node1.get_Id()+","+node2.get_Id()+","+node3.get_Id()+","+node4.get_Id()+","+node5.get_Id()+","+node6.get_Id()+","+node7.get_Id()+","+node8.get_Id()+"] \tNIP = 8 \tMaterial = "+(material != null ? material.name : "");
  ...
  public Object[] get_Array(Canvas3D j3d){
    ...
    if(material==null){
      arr[k++]=new shpQuad(node1.x,node1.y,node1.z,node2.x,node2.y,node2.z,node3.x,node3.y,node3.z,node4.x,node4.y,node4.z,selected ? Canvas3D.SELECTCOLOR : null, contur);
      arr[k++]=new shpQuad(node1.x,node1.y,node1.z,node2.x,node2.y,node2.z,node6.x,node6.y,node6.z,node5.x,node5.y,node5.z,selected ? Canvas3D.SELECTCOLOR : null, contur);
      arr[k++]=new shpQuad(node2.x,node2.y,node2.z,node3.x,node3.y,node3.z,node7.x,node7.y,node7.z,node6.x,node6.y,node6.z,selected ? Canvas3D.SELECTCOLOR : null, contur);
      arr[k++]=new shpQuad(node3.x,node3.y,node3.z,node4.x,node4.y,node4.z,node8.x,node8.y,node8.z,node7.x,node7.y,node7.z,selected ? Canvas3D.SELECTCOLOR : null, contur);
      arr[k++]=new shpQuad(node1.x,node1.y,node1.z,node4.x,node4.y,node4.z,node8.x,node8.y,node8.z,node5.x,node5.y,node5.z,selected ? Canvas3D.SELECTCOLOR : null, contur);
      arr[k++]=new shpQuad(node5.x,node5.y,node5.z,node6.x,node6.y,node6.z,node7.x,node7.y,node7.z,node8.x,node8.y,node8.z,selected ? Canvas3D.SELECTCOLOR : null, contur);
    }else{
      arr[k++]=new shpQuad(node1.x,node1.y,node1.z,node2.x,node2.y,node2.z,node3.x,node3.y,node3.z,node4.x,node4.y,node4.z,selected ? Canvas3D.SELECTCOLOR : material.color, selected ? Canvas3D.SELECTCOLOR : material.color);
      arr[k++]=new shpQuad(node1.x,node1.y,node1.z,node2.x,node2.y,node2.z,node6.x,node6.y,node6.z,node5.x,node5.y,node5.z,selected ? Canvas3D.SELECTCOLOR : material.color, selected ? Canvas3D.SELECTCOLOR : material.color);
      arr[k++]=new shpQuad(node2.x,node2.y,node2.z,node3.x,node3.y,node3.z,node7.x,node7.y,node7.z,node6.x,node6.y,node6.z,selected ? Canvas3D.SELECTCOLOR : material.color, selected ? Canvas3D.SELECTCOLOR : material.color);
      arr[k++]=new shpQuad(node3.x,node3.y,node3.z,node4.x,node4.y,node4.z,node8.x,node8.y,node8.z,node7.x,node7.y,node7.z,selected ? Canvas3D.SELECTCOLOR : material.color, selected ? Canvas3D.SELECTCOLOR : material.color);
      arr[k++]=new shpQuad(node1.x,node1.y,node1.z,node4.x,node4.y,node4.z,node8.x,node8.y,node8.z,node5.x,node5.y,node5.z,selected ? Canvas3D.SELECTCOLOR : material.color, selected ? Canvas3D.SELECTCOLOR : material.color);
      arr[k++]=new shpQuad(node5.x,node5.y,node5.z,node6.x,node6.y,node6.z,node7.x,node7.y,node7.z,node8.x,node8.y,node8.z,selected ? Canvas3D.SELECTCOLOR : material.color, selected ? Canvas3D.SELECTCOLOR : material.color);

    }

    if(j3d.getSHOW_ID_ELEMENT()){
      arr[k++]=new shpOrientedText(get_Id(),(node1.x+node2.x+node3.x+node4.x+node5.x+node6.x+node7.x+node8.x)/8,(node1.y+node2.y+node3.y+node4.y+node5.y+node6.y+node7.y+node8.y)/8,(node1.z+node2.z+node3.z+node4.z+node5.z+node6.z+node7.z+node8.z)/8,contur);
    }

    if(j3d.getSHOW_ID_LOADS() && load!=null)arr[k++]=new shpOrientedText(load.name,(node1.x+node2.x+node3.x+node4.x+node5.x+node6.x+node7.x+node8.x)/8,(node1.y+node2.y+node3.y+node4.y+node5.y+node6.y+node7.y+node8.y)/8,(node1.z+node2.z+node3.z+node4.z+node5.z+node6.z+node7.z+node8.z)/8,load.color);
  ...
  void jButton0_actionPerformed(ActionEvent e) {
      try{
          ...
          if(node1_tmp==null || node2_tmp==null || node3_tmp==null || node4_tmp==null || node5_tmp==null || node6_tmp==null || node7_tmp==null || node8_tmp==null){error("Node = null!"); return;}
...
public void replaceObjectWith(_Object o, _Object replacement) {
    ...
    if (node5 == (_Node)o) node5 = (_Node)replacement;
    if (node6 == (_Node)o) node6 = (_Node)replacement;
    if (node7 == (_Node)o) node7 = (_Node)replacement;
    if (node8 == (_Node)o) node8 = (_Node)replacement;
