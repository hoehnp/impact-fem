 ...
 * 
 * All coordinates are represented in weighted control points i.e. {w*x,w*y,w*z,w}
 *
...
public class _CtrlPoint extends _Point implements Serializable{
  ...
  public String toString(){ return "CtrlPoint ID="+ Id;}
  public MutableTreeNode get_TreeNode(){
    DefaultMutableTreeNode node = new DefaultMutableTreeNode(this);
    node.add(new DefaultMutableTreeNode("Color - ("+color.getRed()+","+color.getGreen()+","+color.getBlue()+")"));
