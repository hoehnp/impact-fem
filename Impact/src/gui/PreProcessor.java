...
public class PreProcessor extends JPanel {
  ...
  private TableModel MatModel = new AbstractTableModel() {
    ...
    public int getRowCount() { return MatDB.size(); }
    public Object getValueAt(int row, int col){
        ...
        for(Enumeration en = MatDB.keys(); en.hasMoreElements();){
          ...
          if(i==row){
            ...
            else if(col==2) return mat.type;
            else if(col==3) return mat.description;
            else return "";
          }
          i++;
        }
    ...
    public boolean isCellEditable(int row, int col) { if(col==3 || col==1)return true; else return false;}
    public void setValueAt(Object aValue, int row, int col) {
      Material mat = (Material)MatDB.get(getValueAt(row,0));
      if(col==1)mat.color=(Color)aValue;
      if(col==3)mat.description=aValue+"";
    }
    public Class getColumnClass(int c) {return getValueAt(0, c).getClass();}
  };
  private TableModel ConstModel = new AbstractTableModel() {
    public int getColumnCount() { return 4; }
    public int getRowCount() { return ConstDB.size(); }
    public Object getValueAt(int row, int col){
        int i=0;
  ...
  private TableModel LoadModel = new AbstractTableModel() {
    ...
    public int getRowCount() { return LoadDB.size(); }
    public Object getValueAt(int row, int col){
        int i=0;
        for(Enumeration en = LoadDB.keys(); en.hasMoreElements();){
          ...
          if(i==row){
            ...
            else if(col==2) return ld.description;
            else return "";
          }
          i++;
        }
    ...
    public String getColumnName(int col) {return LoadHdr[col];}
    public boolean isCellEditable(int row, int col) { if(col==2 || col==1)return true; else return false;}
    public void setValueAt(Object aValue, int row, int col) {
      Loads ld = (Loads)LoadDB.get(getValueAt(row,0));
      if(col==1)ld.color=(Color)aValue;
      if(col==2)ld.description=aValue+"";
    }
    public Class getColumnClass(int c) {return getValueAt(0, c).getClass();}
  };
  ...
  private JTable MatTable = new JTable(MatModel){
    ...
    public TableCellEditor getCellEditor(int row, int column) {
      if(column == 1) {
        Color cl = JColorChooser.showDialog(this,"Pick a Color",((Material)MatDB.get(getValueAt(row,0))).color);
        if(cl!=null)((Material)MatDB.get(getValueAt(row,0))).color=cl;
      }
  ...
  private JTable ConstTable = new JTable(ConstModel){
    public TableCellRenderer getCellRenderer(int row, int column) {
      if(column == 1) {
        DefaultTableCellRenderer render = new DefaultTableCellRenderer();
        render.setBackground(((Constraints)ConstDB.get(getValueAt(row,0))).color);
        render.setForeground(((Constraints)ConstDB.get(getValueAt(row,0))).color);
        return render;
        }else  return super.getCellRenderer(row, column);
    }
    public TableCellEditor getCellEditor(int row, int column) {
      if(column == 1) {
        Color cl = JColorChooser.showDialog(this,"Pick a Color",((Constraints)ConstDB.get(getValueAt(row,0))).color);
        if(cl!=null)((Constraints)ConstDB.get(getValueAt(row,0))).color=cl;
      }
      return super.getCellEditor(row, column);
    }
  };
  private JTable LoadTable = new JTable(LoadModel){
    ...
    public TableCellEditor getCellEditor(int row, int column) {
      if(column == 1) {
        Color cl = JColorChooser.showDialog(this,"Pick a Color",((Loads)LoadDB.get(getValueAt(row,0))).color);
        if(cl!=null)((Loads)LoadDB.get(getValueAt(row,0))).color=cl;
      }
      return super.getCellEditor(row, column);
    }
  };
  ...
  ImageIcon img_open = new ImageIcon(PreProcessor.class.getResource("open.gif"));
  ImageIcon img_save = new ImageIcon(PreProcessor.class.getResource("save.gif"));
  ImageIcon img_list = new ImageIcon(PreProcessor.class.getResource("list.gif"));
  ImageIcon img_add = new ImageIcon(PreProcessor.class.getResource("add.gif"));
  ImageIcon img_groupadd = new ImageIcon(PreProcessor.class.getResource("groupadd.png"));

  ImageIcon img_zoomin = new ImageIcon(PreProcessor.class.getResource("zoomin.gif"));
  ImageIcon img_zoomout = new ImageIcon(PreProcessor.class.getResource("zoomout.gif"));
  ImageIcon img_zoomall = new ImageIcon(PreProcessor.class.getResource("zooma.gif"));
  ...
  ImageIcon img_view_top = new ImageIcon(PreProcessor.class.getResource("view_top.gif"));
  ImageIcon img_view_bottom = new ImageIcon(PreProcessor.class.getResource("view_bottom.gif"));
  ImageIcon img_view_left = new ImageIcon(PreProcessor.class.getResource("view_left.gif"));
  ImageIcon img_view_right = new ImageIcon(PreProcessor.class.getResource("view_right.gif"));
  ImageIcon img_view_front = new ImageIcon(PreProcessor.class.getResource("view_front.gif"));
  ImageIcon img_view_back = new ImageIcon(PreProcessor.class.getResource("view_back.gif"));
  ImageIcon img_view_sw = new ImageIcon(PreProcessor.class.getResource("view_sw.gif"));
  ImageIcon img_view_se = new ImageIcon(PreProcessor.class.getResource("view_se.gif"));
  ImageIcon img_view_ne = new ImageIcon(PreProcessor.class.getResource("view_ne.gif"));
  ImageIcon img_view_nw = new ImageIcon(PreProcessor.class.getResource("view_nw.gif"));
  ImageIcon img_config = new ImageIcon(PreProcessor.class.getResource("config.gif"));
  ImageIcon img_build = new ImageIcon(PreProcessor.class.getResource("build.png"));

  ImageIcon img_point = new ImageIcon(PreProcessor.class.getResource("node.png"));
  ImageIcon img_arc = new ImageIcon(PreProcessor.class.getResource("arc.png"));
  ImageIcon img_nurbcurve = new ImageIcon(PreProcessor.class.getResource("nurbcurve.gif"));

  ImageIcon img_surf_dir = new ImageIcon(PreProcessor.class.getResource("surf_dir.gif"));
  ImageIcon img_surf_rev = new ImageIcon(PreProcessor.class.getResource("surf_rev.gif"));
  ImageIcon img_surf_rule = new ImageIcon(PreProcessor.class.getResource("surf_rule.gif"));
  ImageIcon img_surf_nurb = new ImageIcon(PreProcessor.class.getResource("surf_nurb.gif"));
  ImageIcon img_surf_bil = new ImageIcon(PreProcessor.class.getResource("surf_bil.png"));

  ImageIcon img_border = new ImageIcon(PreProcessor.class.getResource("border.png"));
  ImageIcon img_intersect = new ImageIcon(PreProcessor.class.getResource("intersect.png"));
  ImageIcon img_project = new ImageIcon(PreProcessor.class.getResource("project.png"));
  ImageIcon img_break = new ImageIcon(PreProcessor.class.getResource("break.png"));
  
  ImageIcon img_node = new ImageIcon(PreProcessor.class.getResource("node.png"));
  ImageIcon img_beam = new ImageIcon(PreProcessor.class.getResource("beam.png"));
  ImageIcon img_spring = new ImageIcon(PreProcessor.class.getResource("spring.gif"));
  ImageIcon img_triangle = new ImageIcon(PreProcessor.class.getResource("triangle.png"));
  ImageIcon img_quad = new ImageIcon(PreProcessor.class.getResource("quad.png"));
  ImageIcon img_solid_iso_4 = new ImageIcon(PreProcessor.class.getResource("solid_iso_4.gif"));
  ImageIcon img_solid_iso_6 = new ImageIcon(PreProcessor.class.getResource("solid_iso_6.gif"));
  ImageIcon img_material = new ImageIcon(PreProcessor.class.getResource("material.gif"));
  ImageIcon img_thickness = new ImageIcon(PreProcessor.class.getResource("thickness.png"));

  ImageIcon img_erase = new ImageIcon(PreProcessor.class.getResource("erase.gif"));
  ImageIcon img_move = new ImageIcon(PreProcessor.class.getResource("move.gif"));
  ImageIcon img_rotate = new ImageIcon(PreProcessor.class.getResource("rotate.gif"));
  ImageIcon img_scale = new ImageIcon(PreProcessor.class.getResource("scale.gif"));
  ImageIcon img_transform = new ImageIcon(PreProcessor.class.getResource("transform.gif"));
  ImageIcon img_properties = new ImageIcon(PreProcessor.class.getResource("properties.gif"));
  ImageIcon img_duplicate = new ImageIcon(PreProcessor.class.getResource("duplicate.png"));

  ImageIcon img_constraints = new ImageIcon(PreProcessor.class.getResource("constraints.gif"));
  ImageIcon img_loads = new ImageIcon(PreProcessor.class.getResource("loads.gif"));

  ImageIcon img_grid = new ImageIcon(PreProcessor.class.getResource("grid.gif"));
  ...
  public PreProcessor(boolean ogl) {
    try { jbInit(ogl); } catch(Exception e) { e.printStackTrace();  }
  }
  public void exit(){
    save_loads();
    save_materials();
  ...
  private void jbInit(boolean openGL) throws Exception {
    ...
    b_surf_dir.setToolTipText("Tabulated surface from a path curve and a direction");
    ...
    b_intersect.setToolTipText("Intersect two objects and generate resulting point or curve. Just select two objects and then press this button");
    ...
    b_project.setToolTipText("Project one object onto another object generating a resulting point or curve. Just select two objects and then press this button");
  ...
  void cb_graphicsmode_itemStateChanged(ItemEvent e) {
    ...
    if(cb_graphicsmode.getSelectedIndex()==0)cb_materials.setSelected(false); else cb_materials.setSelected(true);
    J3D.repaint();
  }
  ...
  void command(ActionEvent e) {
    ...
    else if(st_cmd.equalsIgnoreCase("MOVE"))p_cmd.add(new PreProcessor_Move(J3D,this),BorderLayout.CENTER);
    else if(st_cmd.equalsIgnoreCase("ROTATE"))p_cmd.add(new PreProcessor_Rotate(J3D,this),BorderLayout.CENTER);
    else if(st_cmd.equalsIgnoreCase("SCALE"))p_cmd.add(new PreProcessor_Scale(J3D,this),BorderLayout.CENTER);
    else if(st_cmd.equalsIgnoreCase("TRANSFORM"))p_cmd.add(new PreProcessor_Transform(J3D),BorderLayout.CENTER);
    ...
    else if(st_cmd.equalsIgnoreCase("PROPERTIES"))showEditPanel();
    else if(st_cmd.equalsIgnoreCase("SETCONSTRAINTS"))p_cmd.add(new PreProcessor_SetConstraints(J3D,this),BorderLayout.CENTER);
    else if(st_cmd.equalsIgnoreCase("SETLOADS"))p_cmd.add(new PreProcessor_SetLoads(J3D,this),BorderLayout.CENTER);
    else if(st_cmd.equalsIgnoreCase("SETMATERIAL"))p_cmd.add(new PreProcessor_SetMaterial(J3D,this),BorderLayout.CENTER);
    else if(st_cmd.equalsIgnoreCase("SETTHICKNESS"))p_cmd.add(new PreProcessor_SetThickness(J3D,this),BorderLayout.CENTER);
    else if(st_cmd.equalsIgnoreCase("GRID"))p_cmd.add(new PreProcessor_Grid(J3D),BorderLayout.CENTER);
    p_cmd.validate();
    PanelInspector.validate();
  }
      ...
      try {
          ...
          if(choise == JFileChooser.APPROVE_OPTION && fd.getSelectedFile()!=null){
              ...
              if (fd.getFileFilter().equals(f1)) {
                  if(!st.toLowerCase().endsWith(".impact"))st+=".impact";
                  ...
                  try {
                      ...
                      ostream.flush();
                      ostream.close();
                  }catch(Exception ie) { error(ie); }
                  path=st;
              }

              else
                  if (fd.getFileFilter().equals(f2)) {
                      saveSolverModel(st);
                  }
          }
  ...
  void b_open_actionPerformed(ActionEvent e) throws IOException {
      ...
      FileFilter f2 = new FileFilter() {
          public boolean accept(File f) {
              if (f.isDirectory()) return true;
              if (f.getName().toLowerCase().endsWith(".in")) return true;
              return false;
          }
      ...
      FileFilter f3 = new FileFilter() {
          public boolean accept(File f) {
              if (f.isDirectory()) return true;
              if (f.getName().toLowerCase().endsWith(".nas") || f.getName().toLowerCase().endsWith(".nastran") || f.getName().toLowerCase().endsWith(".bdf")) return true;
              return false;
          }
      ...
      FileFilter f4 = new FileFilter() {
          public boolean accept(File f) {
              if (f.isDirectory()) return true;
              if (f.getName().toLowerCase().endsWith(".msh")) return true;
              return false;
          }
      ...
      FileFilter f5 = new FileFilter() {
          public boolean accept(File f) {
              if (f.isDirectory()) return true;
              if (f.getName().toLowerCase().endsWith(".unv")) return true;
              return false;
          }
  ...
  void b_material_actionPerformed(ActionEvent e) {
    ...
    m_new.addActionListener(new ActionListener() {
      public void actionPerformed(ActionEvent e) {
        ...
        String[] st = {"Elastic","Elastoplastic","ThermoElastoplastic","Spring"};
        ...
        b_col.addActionListener(new java.awt.event.ActionListener() {
          public void actionPerformed(ActionEvent e) {
            Color cl = JColorChooser.showDialog(getFrame(PanelInspector),"Pick a Color",getColorLine(id_color));
            if(cl!=null)((JButton)e.getSource()).setBackground(cl);
          }
        });
        ...
        int result = JOptionPane.showOptionDialog(getFrame(PanelInspector),p2,"New Material",JOptionPane.YES_NO_OPTION,JOptionPane.PLAIN_MESSAGE,null,null,null);
        if(result!=0) return;
        id_color++;
    ...
    JOptionPane.showMessageDialog(getFrame(PanelInspector), p, "Material", JOptionPane.PLAIN_MESSAGE);
  ...
  public void load_materials(){
    try{
      MatDB.clear();
      RandomAccessFile fin = new RandomAccessFile("Material.properties","r");
      String st;
      while((st=fin.readLine())!=null){
        ...
        mat.color = new Color(Integer.parseInt(stt.nextToken()),Integer.parseInt(stt.nextToken()),Integer.parseInt(stt.nextToken()));
  ...
  public void load_constraints(){
    try{
      ConstDB.clear();
      RandomAccessFile fin = new RandomAccessFile("Constraints.properties","r");
      String st;
      while((st=fin.readLine())!=null){
        ...
        StringTokenizer stt = new StringTokenizer(fin.readLine());
        con.color = new Color(Integer.parseInt(stt.nextToken()),Integer.parseInt(stt.nextToken()),Integer.parseInt(stt.nextToken()));
  ...
  public void load_loads(){
    try{
      ...
      while((st=fin.readLine())!=null){
        ...
        StringTokenizer stt = new StringTokenizer(fin.readLine());
        ld.color = new Color(Integer.parseInt(stt.nextToken()),Integer.parseInt(stt.nextToken()),Integer.parseInt(stt.nextToken()));
  ...
  public void save_materials(){
    try{
      ...
      for(Enumeration en = MatDB.keys(); en.hasMoreElements();){
        ...
        fout.writeBytes(mat.color.getRed()+" "+mat.color.getGreen()+" "+mat.color.getBlue()+"\n");
      }
      fout.close();
      J3D.tree_reset();
      J3D.view_reset();
  ...
  public void save_constraints(){
    try{
      ...
      for(Enumeration en = ConstDB.keys(); en.hasMoreElements();){
        ...
        fout.writeBytes(con.color.getRed()+" "+con.color.getGreen()+" "+con.color.getBlue()+"\n");
      }
      fout.close();
      J3D.tree_reset();
      J3D.view_reset();
  ...
  public void save_loads(){
    try{
      ...
      for(Enumeration en = LoadDB.keys(); en.hasMoreElements();){
        ...
        fout.writeBytes(ld.color.getRed()+" "+ld.color.getGreen()+" "+ld.color.getBlue()+"\n");
      }
      fout.close();
      J3D.tree_reset();
      J3D.view_reset();
  ...
  void b_config_actionPerformed(ActionEvent e) {
    ...
    JTextField tf_CONTROLS_PRINT_STEP = new JTextField(CONTROLS_PRINT_STEP,5);
    JTextField tf_CONTROLS_PRINT_TRACKER_STEP = new JTextField(CONTROLS_PRINT_TRACKER_STEP,5);
    ...
    JOptionPane.showMessageDialog(this,p,"Properties",JOptionPane.PLAIN_MESSAGE,null);
    if(cb_node_0.isSelected())J3D.setPOINTSIZE(4); else J3D.setPOINTSIZE(0);
    ...
    }else cb_graphicsmode.setSelectedIndex(1);
  ...
  void b_constraints_actionPerformed(ActionEvent e) {
    ...
    m_new.addActionListener(new ActionListener() {
      public void actionPerformed(ActionEvent e) {
        ...
        p6.add(new JLabel("Color"), BorderLayout.WEST);
        p6.add(b_col, BorderLayout.CENTER);
        int result = JOptionPane.showOptionDialog(getFrame(PanelInspector),p2,"New Constraints",JOptionPane.YES_NO_OPTION,JOptionPane.PLAIN_MESSAGE,null,null,null);
        if(result!=0) return;
        id_color++;
        Constraints con = new Constraints();
    ...
    JOptionPane.showMessageDialog(getFrame(PanelInspector), p, "Constraints",JOptionPane.PLAIN_MESSAGE);
  ...
  void b_loads_actionPerformed(ActionEvent e) {
    ...
    m_new.addActionListener(new ActionListener() {
      public void actionPerformed(ActionEvent e) {
        ...
        p6.add(new JLabel("Color"), BorderLayout.WEST);
        p6.add(b_col, BorderLayout.CENTER);
        int result = JOptionPane.showOptionDialog(getFrame(PanelInspector),p2,"New Loads",JOptionPane.YES_NO_OPTION,JOptionPane.PLAIN_MESSAGE,null,null,null);
        if(result!=0) return;
        id_color++;
        Loads ld = new Loads();
    ...
    JOptionPane.showMessageDialog(getFrame(PanelInspector), p, "Loads", JOptionPane.PLAIN_MESSAGE);
  ...
  public void showEditPanel() {
    ...
    for(int j=0; j<obj.length; j++){
      ...
      if(uobj instanceof _Object){
        p_cmd.removeAll();
        p_cmd.add(((_Object)uobj).getEditPanel(J3D,this),BorderLayout.CENTER);
        p_cmd.validate();
        PanelInspector.validate();
      }
    }
...
public void clearEditPanel() {
  ...
  public void resetselect() {
    ...
    for(int i=0; i<tp.length; i++){
      ...
      if(obj instanceof _Object)  ((_Object)obj).setSelected(true);
    }
  }
  ...
  private void mergeNodes(float merge_distance) {
      ...
      for (int i = 0; i < narr.length; i++) 
          for (int j=i+1; j < narr.length; j++) {
              ...
              dist = (narr[i].x - narr[j].x)*(narr[i].x - narr[j].x) + (narr[i].y - narr[j].y)*(narr[i].y - narr[j].y) + (narr[i].z - narr[j].z)*(narr[i].z - narr[j].z);
              
              if (dist <= merge_distance) 
                  if (narr[j].getMergedReference().getMaster_type() < narr[i].getMergedReference().getMaster_type()) 
  ...
  private void saveSolverModel(String file_in) {
    ...
    StringBuffer geo_SurfBil = new StringBuffer("GEOMETRY OF TYPE SurfBil\n");
    StringBuffer geo_SurfDir = new StringBuffer("GEOMETRY OF TYPE SurfDir\n");
    StringBuffer geo_SurfFill = new StringBuffer("GEOMETRY OF TYPE SurfFill\n");
    StringBuffer geo_SurfRev = new StringBuffer("GEOMETRY OF TYPE SurfRev\n");
    StringBuffer geo_SurfRul = new StringBuffer("GEOMETRY OF TYPE SurfRul\n");

    
    String s = JOptionPane.showInputDialog("Enter node merge distance\nor select Cancel to prevent merging",new Float(J3D.getNODE_MERGE_TOLERANCE()));
    ...
    for(int j=0; j<earr.length; j++){
    	if(earr[j] instanceof _Element2 && ((_Element2)earr[j]).msh_type == Canvas3D.MESH_Beam_2) st_elements_Beam_2.append(((_Element2)earr[j]).writeObject()+"\n");
    	else 
    		if(earr[j] instanceof _Element2 && ((_Element2)earr[j]).msh_type == Canvas3D.MESH_Contact_Line) st_elements_Contact_Line.append(((_Element2)earr[j]).writeObject()+"\n");
    		else 
    			if(earr[j] instanceof _Element2 && ((_Element2)earr[j]).msh_type == Canvas3D.MESH_Rod_2) st_elements_Rod_2.append(((_Element2)earr[j]).writeObject()+"\n");
    			else 
    				if(earr[j] instanceof _Element3 && ((_Element3)earr[j]).msh_type==Canvas3D.MESH_Contact_Triangle) st_elements_Contact_Triangle.append(((_Element3)earr[j]).writeObject()+"\n");
    				else 
    					if(earr[j] instanceof _Element3 && ((_Element3)earr[j]).msh_type==Canvas3D.MESH_Shell_C0_3) st_elements_Shell_C0_3.append(((_Element3)earr[j]).writeObject()+"\n");
    					else 
    						if(earr[j] instanceof _Element4 && ((_Element4)earr[j]).msh_type==Canvas3D.MESH_Shell_BT_4) st_elements_Shell_BT_4.append(((_Element4)earr[j]).writeObject()+"\n");
    						else 
    							if(earr[j] instanceof _Element4 && ((_Element4)earr[j]).msh_type==Canvas3D.MESH_Solid_Iso_4) st_elements_Solid_Iso_4.append(((_Element4)earr[j]).writeObject()+"\n");
    							else 
    								if(earr[j] instanceof _Element8) st_elements_Solid_Iso_6.append(((_Element8)earr[j]).writeObject()+"\n");
    }
    
    st_elements.append((st_elements_Rod_2.length()>23?st_elements_Rod_2.toString()+"\n\n":"")
               +(st_elements_Beam_2.length()>24?st_elements_Beam_2.toString()+"\n\n":"")
               +(st_elements_Beam_Spring_2.length()>31?st_elements_Beam_Spring_2.toString()+"\n\n":"")
               +(st_elements_Contact_Line.length()>30?st_elements_Contact_Line.toString()+"\n\n":"")
               +(st_elements_Contact_Triangle.length()>34?st_elements_Contact_Triangle.toString()+"\n\n":"")
               +(st_elements_Shell_C0_3.length()>28?st_elements_Shell_C0_3.toString()+"\n\n":"")
               +(st_elements_Shell_BT_4.length()>28?st_elements_Shell_BT_4.toString()+"\n\n":"")
               +(st_elements_Solid_Iso_4.length()>29?st_elements_Solid_Iso_4.toString()+"\n\n":"")
               +(st_elements_Solid_Iso_6.length()>29?st_elements_Solid_Iso_6.toString():""));

    // Create printout of geometry
    headerMessage("Printing geometry");
    for(int j=0; j<geoarr.length; j++){
        if(geoarr[j] instanceof _Point) geo_Point.append(geoarr[j].writeObject()+"\n");
        else
            if(geoarr[j] instanceof _Arc) geo_Arc.append(geoarr[j].writeObject()+"\n");
            else
                if(geoarr[j] instanceof _Spline) geo_Spline.append(geoarr[j].writeObject()+"\n");
                else
                    if(geoarr[j] instanceof _SurfBil) geo_SurfBil.append(geoarr[j].writeObject()+"\n");
                    else
                        if(geoarr[j] instanceof _SurfDir) geo_SurfDir.append(geoarr[j].writeObject()+"\n");
                        else
                            if(geoarr[j] instanceof _SurfFill) geo_SurfFill.append(geoarr[j].writeObject()+"\n");
                            else
                                if(geoarr[j] instanceof _SurfRev) geo_SurfRev.append(geoarr[j].writeObject()+"\n");
                                else
                                    if(geoarr[j] instanceof _SurfRul) geo_SurfRul.append(geoarr[j].writeObject()+"\n");
    ...
    for(Enumeration en = MatDB.keys(); en.hasMoreElements();){
      ...
      if(st_elements.indexOf("Material = "+mat.name)!=-1) st_model.append(st);
    }
    ...
    for(Enumeration en = ConstDB.keys(); en.hasMoreElements();){
      ...
      if(st_nodes.indexOf("Constraint = "+con.name)!=-1)st_model.append(st);
    }
    ...
    for(Enumeration en = LoadDB.keys(); en.hasMoreElements();){
      ...
      if(st_nodes.indexOf("Load = "+ld.name)!=-1 || st_elements.indexOf("Load = "+ld.name)!=-1)st_model.append(st);
    }
  ...
  public void rescanTree() {
      ...
      DefaultMutableTreeNode tn = (DefaultMutableTreeNode)tp.getPathComponent(0);
  ...
  /**
   *
   * This method goes through the tree and checks which nodes that have
   * been selected. If a node is selected, the corresponding _Object is
   * set as selected in the canvas3D view.
   * Finally, the view is redrawn.
   *
  ...
  public void treeSelectionChanged() {
          ...
          for(int i=0; i<tp.length; i++){
              ...
              Object obj = tn.getUserObject();
              int count = 0;
              if(obj instanceof _Object){ ((_Object)obj).setSelected(true); count++; }
              /*
               int lev = tn.getLevel();
               while((tn=tn.getNextNode())!=null && lev<tn.getLevel()){
               obj = tn.getUserObject();
               if(obj instanceof _Object){ ((_Object)obj).Select(tp[i]+""); count++; }
               }
               */
              if(count==0){
                  obj = ((DefaultMutableTreeNode)tp[i].getParentPath().getLastPathComponent()).getUserObject();
                  if(obj instanceof _Object) ((_Object)obj).setSelected(true);
              }
          }
          J3D.view_reset();
 ...
 public void headerMessage(String m, float progress) {
     ...
     progress *= 10.0;
     String s1 = s.substring(0,s.lastIndexOf("]")+1);
     f.setTitle(s1+" " + m + "|" + p.substring(0,(int)progress) + e.substring((int)progress,11));
 ...
 /**
  * Reads a Gmsh version 2 mesh file and generates elements and nodes in the preprocessor
  * 
  * @param filename
  */
 public void readGmsh(String filename) throws FileNotFoundException, IOException, ParseException {
     
     // Define regexp patterns for the data to import
     Regex Element = new Regex("^([0-9]+)\\s+([0-9]+)\\s+([0-9]+)\\s+([0-9]+)?\\s*([0-9]+)?\\s*([0-9]+)?\\s*([0-9]+)?\\s*([0-9]+)?\\s*([0-9]+)?\\s*([0-9]+)?\\s*([0-9]+)?\\s*([0-9]+)?\\s*([0-9]+)?\\s*([0-9]+)?\\s*([0-9]+)?\\s*([0-9]+)?\\s*([0-9]+)?\\s*([0-9]+)?\\s*([0-9]+)?\\s*([0-9]+)?\\s*([0-9]+)?\\s*([0-9]+)?\\s*([0-9]+)?\\s*([0-9]+)?\\s*([0-9]+)?\\s*([0-9]+)?\\s*([0-9]+)?\\s*([0-9]+)?\\s*([0-9]+)?\\s*([0-9]+)?\\s*([0-9]+)?\\s*([0-9]+)?\\s*([0-9]+)?\\s*([0-9]+)?\\s*([0-9]+)?\\s*([0-9]+)?\\s*([0-9]+)?\\s*$");
     
     Regex Node = new Regex("^([0-9]+)\\s+([-+]?[0-9]+[.]?[0-9]*([eE][-+]?[0-9]+)?)\\s+([-+]?[0-9]+[.]?[0-9]*([eE][-+]?[0-9]+)?)\\s+([-+]?[0-9]+[.]?[0-9]*([eE][-+]?[0-9]+)?)\\s*$");
     ...
     // Start parsing
     while (!RNodes.search(str = br.readLine())) linenr++;
     
     // Start reading nodes
     str = br.readLine();
     linenr++;
     
     if (NrOf.search(str)) nr_of_nodes = Integer.parseInt(NrOf.stringMatched(1));
         else throw new ParseException("No number of nodes found in Gmsh file:" + filename,linenr);

     i = 0;
     while (Node.search(str = br.readLine())) {
         
         linenr++;
         n = new _Node(Float.parseFloat(Node.stringMatched(2)),Float.parseFloat(Node.stringMatched(4)),Float.parseFloat(Node.stringMatched(6)));
     ...
     // Read elements
     while (!RElem.search(str = br.readLine())) linenr++;
     
     str = br.readLine();
     linenr++;
     
     if (NrOf.search(str)) nr_of_elements = Integer.parseInt(NrOf.stringMatched(1));
         else throw new ParseException("No number of elements found in Gmsh file:" + filename,linenr);
     
     i = 0;
     while (Element.search(str = br.readLine())) {
         
         linenr++;
         headerMessage("Reading Elements ",(float)i++/(float)nr_of_elements);

         switch(Integer.parseInt(Element.stringMatched(2))) {
         
         case 1:
             nn[0] = Element.stringMatched(Integer.parseInt(Element.stringMatched(3))+4);
             nn[1] = Element.stringMatched(Integer.parseInt(Element.stringMatched(3))+5);
             if (nn[0] == null || nn[1] == null)
                 throw new ParseException("No node number for element:" + Element.stringMatched(1),linenr);
             // Generate element
             el = new _Element2((_Node)nodes.get(nn[0]), (_Node)nodes.get(nn[1]));
             g_e.addToGroup(el);
             J3D.add3D(el);
         break;
         ...
         case 2:
             nn[0] = Element.stringMatched(Integer.parseInt(Element.stringMatched(3))+4);
             nn[1] = Element.stringMatched(Integer.parseInt(Element.stringMatched(3))+5);
             nn[2] = Element.stringMatched(Integer.parseInt(Element.stringMatched(3))+6);
             if (nn[0] == null || nn[1] == null || nn[2] == null)
                 throw new ParseException("No node number for element:" + Element.stringMatched(1),linenr);
             // Generate element
             el = new _Element3((_Node)nodes.get(nn[0]), (_Node)nodes.get(nn[1]), (_Node)nodes.get(nn[2]));
             g_e.addToGroup(el);
             J3D.add3D(el);
         break;
         ...
         case 3:
             ...
             nn[1] = Element.stringMatched(Integer.parseInt(Element.stringMatched(3))+5);
             nn[2] = Element.stringMatched(Integer.parseInt(Element.stringMatched(3))+6);
             nn[3] = Element.stringMatched(Integer.parseInt(Element.stringMatched(3))+7);
             if (nn[0] == null || nn[1] == null || nn[2] == null || nn[3] == null)
                 throw new ParseException("No node number for element:" + Element.stringMatched(1),linenr);
             // Generate element
             el = new _Element4((_Node)nodes.get(nn[0]), (_Node)nodes.get(nn[1]),(_Node)nodes.get(nn[2]), (_Node)nodes.get(nn[3]),Canvas3D.MESH_Shell_BT_4);
             g_e.addToGroup(el);
             J3D.add3D(el);
         break;
         ...
         case 4:
             ...
             if (nn[0] == null || nn[1] == null || nn[2] == null || nn[3] == null)
                 throw new ParseException("No node number for element:" + Element.stringMatched(1),linenr);
             // Generate element
             el = new _Element4((_Node)nodes.get(nn[0]), (_Node)nodes.get(nn[1]),(_Node)nodes.get(nn[2]), (_Node)nodes.get(nn[3]),Canvas3D.MESH_Solid_Iso_4);
             g_e.addToGroup(el);
             J3D.add3D(el);
         break;
         ...
         case 5:
             for (int j=0; j<7; j++) {
                 nn[j] = Element.stringMatched(Integer.parseInt(Element.stringMatched(3))+j+4);
                 if (nn[j] == null)
                     throw new ParseException("No node number for element:" + Element.stringMatched(1),linenr);
             }
             // Generate element
             el = new _Element8((_Node)nodes.get(nn[0]), (_Node)nodes.get(nn[1]),(_Node)nodes.get(nn[2]), (_Node)nodes.get(nn[3]), (_Node)nodes.get(nn[4]), (_Node)nodes.get(nn[5]),(_Node)nodes.get(nn[6]), (_Node)nodes.get(nn[7]));
             g_e.addToGroup(el);
             J3D.add3D(el);
         break;
         ...
         case 6:   // 6-node prism
             ...
             // Generate element
             el = new _Element8((_Node)nodes.get(nn[0]), (_Node)nodes.get(nn[1]),(_Node)nodes.get(nn[2]), (_Node)nodes.get(nn[2]), (_Node)nodes.get(nn[3]), (_Node)nodes.get(nn[4]),(_Node)nodes.get(nn[5]), (_Node)nodes.get(nn[5]));
             g_e.addToGroup(el);
             J3D.add3D(el);
         break;
         ...
         case 7:   // 5-node pyramid
             ...
             // Generate element
             el = new _Element8((_Node)nodes.get(nn[0]), (_Node)nodes.get(nn[1]),(_Node)nodes.get(nn[2]), (_Node)nodes.get(nn[3]), (_Node)nodes.get(nn[4]), (_Node)nodes.get(nn[4]),(_Node)nodes.get(nn[4]), (_Node)nodes.get(nn[4]));
             g_e.addToGroup(el);
             J3D.add3D(el);
         break;
         ...
         default:
             throw new ParseException("Unsupported element type in Gmsh file:" + filename, linenr);
...
/**
  ...
  * @param filename
  */
 public void readNastran(String filename) throws FileNotFoundException, IOException, ParseException {
     
     // Define regexp patterns for the data to import
     Regex GRID = new Regex("^GRID    ([0-9 ]{8})([0-9 ]{8})([+\\-0-9.eE ]{8})([+\\-0-9.eE ]{8})([+\\-0-9.eE ]{1,8})([0-9 ]{1,8})?([0-9eE ]{1,8})? *$");
     Regex GRIDS1 = new Regex("^GRID\\*   ([0-9 ]{16})([0-9 ]{16})([+\\-0-9.eE ]{16})([+\\-0-9.eE ]{1,16}) *$");
     Regex GRIDS2 = new Regex("^\\*       ([+\\-0-9.eE ]{1,16})([0-9 ]{1,16})?([0-9eE ]{1,16})? *$");
     Regex FGRID = new Regex("^GRID\\*,([0-9 ]+),([0-9 ]+),([-+]?[0-9]+[.]?[0-9]*(?:[eE][-+]?[0-9]+)?),([-+]?[0-9]+[.]?[0-9]*(?:[eE][-+]?[0-9]+)?),([-+]?[0-9]+[.]?[0-9]*(?:[eE][-+]?[0-9]+)?),([0-9 ]+)?,?([0-9 ]{8})? *");
     
     Regex CBAR = new Regex("^CBAR    ([0-9 ]{8})([0-9 ]{8})([0-9 ]{8})([0-9 ]{1,8})([+\\-0-9. eE]{1,8})?([+\\-0-9. eE]{1,8})?([+\\-0-9. eE]{1,8})? *$");
     Regex CTRIA3 = new Regex("^CTRIA3  ([0-9 ]{8})([0-9 ]{8})([0-9 ]{8})([0-9 ]{8})([0-9 ]{1,8})([+\\-0-9. eE]{8})?([0-9 ]{8})?([+\\-0-9. eE]{8})? *$");
     Regex CQUAD4 = new Regex("^CQUAD4  ([0-9 ]{8})([0-9 ]{8})([0-9 ]{8})([0-9 ]{8})([0-9 ]{8})([0-9 ]{1,8})([+\\-0-9. eE]{8})?([0-9 ]{8})?([+\\-0-9. eE]{8})? *$");
     Regex CTETRA = new Regex("^CTETRA  ([0-9 ]{8})([0-9 ]{8})([0-9 ]{8})([0-9 ]{8})([0-9 ]{8})([0-9 ]{1,8})([+\\-0-9. eE]{8})?([0-9 ]{8})?([+\\-0-9. eE]{8})? *$");
     Regex CHEXA1 = new Regex("^CHEXA   ([0-9 ]{8})([0-9 ]{8})([0-9 ]{8})([0-9 ]{8})([0-9 ]{8})([0-9 ]{8})([0-9 ]{8})([0-9 ]{1,8}).*$");
     Regex CHEXA2 = new Regex("^........([0-9 ]{8})([0-9 ]{1,8})([+\\-0-9. eE]{8})?([0-9 ]{8})?([+\\-0-9. eE]{8})? *$");
     Regex CPENTA = new Regex("^CPENTA  ([0-9 ]{8})([0-9 ]{8})([0-9 ]{8})([0-9 ]{8})([0-9 ]{8})([0-9 ]{8})([0-9 ]{8})([0-9 ]{1,8})[ +]*$");
     ...
     while ((str = br.readLine()) != null) {
         ...
         if (GRID.search(str)) {
             linenr++;
             n = new _Node(Float.parseFloat(TO_ENG.replaceAllFrom(GRID.stringMatched(3),2)),Float.parseFloat(TO_ENG.replaceAllFrom(GRID.stringMatched(4),2)),Float.parseFloat(TO_ENG.replaceAllFrom(GRID.stringMatched(5),2)));
             nodes.put(GRID.stringMatched(1).trim(),n);  //Nodenr, nodeobject
             g_n.addToGroup(n);
             J3D.add3D(n);
             headerMessage("Reading Node: " + i++);
         }
         else 
         if (GRIDS1.search(str)) {
             linenr++;
             float x,y,z;
             x = Float.parseFloat(TO_ENG.replaceAll(GRIDS1.stringMatched(3)));
             y = Float.parseFloat(TO_ENG.replaceAll(GRIDS1.stringMatched(4)));
             if (!GRIDS2.search(str = br.readLine()))
                 throw new ParseException("No second line found for GRID*:" + CHEXA1.stringMatched(1),linenr);
             z = Float.parseFloat(TO_ENG.replaceAll(GRIDS2.stringMatched(1)));
             n = new _Node(x,y,z);
             nodes.put(GRIDS1.stringMatched(1).trim(),n);  //Nodenr, nodeobject
             g_n.addToGroup(n);
             J3D.add3D(n);
             headerMessage("Reading Node: " + i++);
         }
         ...
         if (FGRID.search(str)) {
             linenr++;
             n = new _Node(Float.parseFloat(TO_ENG.replaceAll(FGRID.stringMatched(3))),Float.parseFloat(TO_ENG.replaceAll(FGRID.stringMatched(4))),Float.parseFloat(TO_ENG.replaceAll(FGRID.stringMatched(5))));
             nodes.put(FGRID.stringMatched(1).trim(),n);  //Nodenr, nodeobject
             g_n.addToGroup(n);
             J3D.add3D(n);
             headerMessage("Reading Node: " + i++);
         }
     ...
     if (CBAR.search(str)) {
         ...
         if (nn[j] == null)
             throw new ParseException("No node number for element:" + CBAR.stringMatched(1),linenr);
         nod[j] = (_Node)nodes.get(nn[j]);
         if (nod[j] == null)
             throw new ParseException("No matching node found for element:" + CBAR.stringMatched(1),linenr);
         }
     ...
     if (CTRIA3.search(str)) {
         for (int j=0; j<3; j++) {
         nn[j] = CTRIA3.stringMatched(j+3).trim();
         if (nn[j] == null)
             throw new ParseException("No node number for element:" + CTRIA3.stringMatched(1),linenr);
         nod[j] = (_Node)nodes.get(nn[j]);
         if (nod[j] == null)
             throw new ParseException("No matching node found for element:" + CTRIA3.stringMatched(1),linenr);
         }
         ...
         if (CQUAD4.search(str)) {
             for (int j=0; j<4; j++) {
             nn[j] = CQUAD4.stringMatched(j+3).trim();
             if (nn[j] == null)
                 throw new ParseException("No node number for element:" + CQUAD4.stringMatched(1),linenr);
             nod[j] = (_Node)nodes.get(nn[j]);
             if (nod[j] == null)
                 throw new ParseException("No matching node found for element:" + CQUAD4.stringMatched(1),linenr);
             }
             
             // Generate element
             el = new _Element4(nod[0], nod[1],  nod[2],  nod[3], Canvas3D.MESH_Shell_BT_4);
             g_e.addToGroup(el);
             J3D.add3D(el);
             headerMessage("Reading CQUAD4: " + i++);
         }
     else
         if (CTETRA.search(str)) {
             for (int j=0; j<4; j++) {
             nn[j] = CTETRA.stringMatched(j+3).trim();
             if (nn[j] == null)
                 throw new ParseException("No node number for element:" + CTETRA.stringMatched(1),linenr);
             nod[j] = (_Node)nodes.get(nn[j]);
             if (nod[j] == null)
                 throw new ParseException("No matching node found for element:" + CTETRA.stringMatched(1),linenr);
             }
                 
             // Generate element
             el = new _Element4(nod[0], nod[1],  nod[2],  nod[3], Canvas3D.MESH_Solid_Iso_4);
             g_e.addToGroup(el);
             J3D.add3D(el);
             headerMessage("Reading CTETRA: " + i++);
         }
     else
         if (CHEXA1.search(str)) {
             for (int j=0; j<6; j++) {
             nn[j] = CHEXA1.stringMatched(j+3).trim();
             if (nn[j] == null)
                 throw new ParseException("No node number for element:" + CHEXA1.stringMatched(1),linenr);
             nod[j] = (_Node)nodes.get(nn[j]);
             if (nod[j] == null)
                 throw new ParseException("No matching node "+nn[j]+" found for element:" + CHEXA1.stringMatched(1),linenr);
             }
               
             if (!CHEXA2.search(str = br.readLine()))
                 throw new ParseException("No last two nodes found for element:" + CHEXA1.stringMatched(1),linenr);
             for (int j=6; j<8; j++) {
             ...
             // Generate element
             el = new _Element8(nod[0], nod[1],  nod[2],  nod[3], nod[4], nod[5],  nod[6],  nod[7]);
             g_e.addToGroup(el);
             J3D.add3D(el);
             headerMessage("Reading CHEXA: " + i++);
         }
         else
             if (CPENTA.search(str)) {
                 for (int j=0; j<6; j++) {
                 nn[j] = CPENTA.stringMatched(j+3).trim();
                 if (nn[j] == null)
                     throw new ParseException("No node number for element:" + CPENTA.stringMatched(1),linenr);
                 nod[j] = (_Node)nodes.get(nn[j]);
                 if (nod[j] == null)
                     throw new ParseException("No matching node "+nn[j]+" found for element:" + CPENTA.stringMatched(1),linenr);
                 }
                 
                 // Generate element
                 el = new _Element8(nod[0], nod[1],  nod[2],  nod[2], nod[3], nod[4],  nod[5],  nod[5]);
                 g_e.addToGroup(el);
                 J3D.add3D(el);
...
/**
  ...
  * @param filename
  */
 public void readUNV(String filename) throws FileNotFoundException, IOException, ParseException {
     ...
     Regex NODE1 = new Regex("^([+\\-0-9 ]{10})([+\\-0-9 ]{10})([+\\-0-9 ]{10})([+\\-0-9 ]{1,10})\\s*$");
     Regex NODE2 = new Regex("^([+\\-0-9.eED ]{25})([+\\-0-9.eED ]{25})([+\\-0-9.eED ]{1,25})\\s*$");
     
     Regex ELEMENT1 = new Regex("^([0-9 ]{10})([0-9 ]{10})([0-9 ]{10})([0-9 ]{10})([0-9 ]{10})([0-9 ]{10})\\s*$");
     Regex ELEMENT2 = new Regex("^([0-9 ]{10})([0-9 ]{10})([0-9 ]{10})?([0-9 ]{10})?([0-9 ]{10})?([0-9 ]{10})?([0-9 ]{10})?([0-9 ]{10})?\\s*$");
     ...
     while ((str = br.readLine()) != null) {
         ...
         if (SETNODES.search(str)) inblock = true;
         if (END.search(str)) inblock = false;
         ...
         if (inblock) {
             ...
             if (NODE2.search(str)) {
                 n = new _Node(Float.parseFloat(TO_ENG.replaceAll(NODE2.stringMatched(1))),Float.parseFloat(TO_ENG.replaceAll(NODE2.stringMatched(2))),Float.parseFloat(TO_ENG.replaceAll(NODE2.stringMatched(3))));
     ...
     while ((str = br.readLine()) != null) {
         ...
         if (SETELEMENTS.search(str)) inblock = true;
         if (END.search(str)) inblock = false;
         ...
         if (inblock) {
             ...
             if (ELEMENT2.search(str) && eltype < 41)   // Skip one line for beam and rod elements 
                 str = br.readLine();

             if (nnodes > 8)
                 throw new ParseException("Impact does not support higher order elements. Error at element:" + elname, linenr);
             
             if (ELEMENT2.search(str) && nnodes <= 8) {
                 for (int j=0; j<nnodes; j++) {
                     nn[j] = ELEMENT2.stringMatched(j+1).trim();
                     if (nn[j] == null)
                         throw new ParseException("No node number for element:" + elname, linenr);
                     nod[j] = (_Node)nodes.get(nn[j]);
                     if (nod[j] == null)
                         throw new ParseException("No matching node found for element:" + elname, linenr);
                 }
                 ...
                 case 44:
                     o = new _Element4(nod[0], nod[1], nod[2], nod[3], Canvas3D.MESH_Shell_BT_4);
                     J3D.add3D(o);
                     g_e.addToGroup(o);
                 ...
                 case 111:
                     o = new _Element4(nod[0], nod[1], nod[2], nod[3], Canvas3D.MESH_Solid_Iso_4);
                     J3D.add3D(o);
                     g_e.addToGroup(o);
                 ...
                 case 112:
                     o = new _Element8(nod[0], nod[1], nod[2], nod[2], nod[3], nod[4], nod[5], nod[5]);
                     J3D.add3D(o);
                     g_e.addToGroup(o);
                 ...
                 case 115:
                     o = new _Element8(nod[0], nod[1], nod[2], nod[3], nod[4], nod[5], nod[6], nod[7]);
                     J3D.add3D(o);
                     g_e.addToGroup(o);
 ...
 public void readIN(String filename) throws FileNotFoundException, IOException, ParseException {
         ...
         if(st.startsWith("CONTROLS")){
             ContpolsDB = st+"\n";
                 while (stt.hasMoreTokens()) {
                     ...
                     if(st.startsWith("GROUPS") || st.startsWith("NODES") || st.startsWith("ELEMENTS") || st.startsWith("MATERIALS") || st.startsWith("TRACKERS") || st.indexOf("BOUNDARY_CONDITION")!=-1 || st.indexOf("RIGID_BODY")!=-1 || st.indexOf("LOADS")!=-1)break;
                     ContpolsDB += st+"\n";
                 }
         }
     }
     ...
     while (stt.hasMoreTokens()) {
         ...
         if(st.startsWith("TRACKERS")){
             TrackersDB = st+"\n";
                 while (stt.hasMoreTokens()) {
                     st = stt.nextToken().trim().toUpperCase();
                     if(st.startsWith("#") || st.length()==0)continue;
                     if(st.startsWith("GROUPS") || st.startsWith("NODES") || st.startsWith("ELEMENTS") || st.startsWith("CONTROLS") || st.startsWith("MATERIALS") || st.indexOf("BOUNDARY_CONDITION")!=-1 || st.indexOf("RIGID_BODY")!=-1 || st.indexOf("LOADS")!=-1)break;
                     TrackersDB += st+"\n";
                 }
         }
         ...
         while (stt.hasMoreTokens()) {
             ...
             if(st.startsWith("MATERIALS")){
                 ...
                 while (stt.hasMoreTokens()) {
                     ...
                     if(st.startsWith("GROUPS") || st.startsWith("NODES") || st.startsWith("ELEMENTS") || st.startsWith("CONTROLS") || st.startsWith("TRACKERS") || st.indexOf("BOUNDARY_CONDITION")!=-1 || st.indexOf("RIGID_BODY")!=-1 || st.indexOf("LOADS")!=-1)break;
         ...
         while (stt.hasMoreTokens()) {
             ...
             if(st.startsWith("CONSTRAINTS")){
                 ...
                 while (stt.hasMoreTokens()) {
                     ...
                     if(st.startsWith("GROUPS") || st.startsWith("NODES") || st.startsWith("ELEMENTS") || st.startsWith("CONTROLS") || st.startsWith("TRACKERS") || st.startsWith("MATERIALS")  || st.indexOf("LOADS")!=-1)break;
                     StringTokenizer stt1 = new StringTokenizer(st," =\t");
         ...
         while (stt.hasMoreTokens()) {
             ...
             if(st.startsWith("LOADS")){
                 while (stt.hasMoreTokens()) {
                     ...
                     if(st.startsWith("GROUPS") || st.startsWith("NODES") || st.startsWith("ELEMENTS") || st.startsWith("CONTROLS") || st.startsWith("TRACKERS") || st.startsWith("MATERIALS")  || st.indexOf("BOUNDARY_CONDITION")!=-1 || st.indexOf("RIGID_BODY")!=-1)break;
                     StringTokenizer stt1 = new StringTokenizer(st," =\t");
         ...
         while (stt.hasMoreTokens()) {
             ...
             if(st.equals("NODES")){
                 while (stt.hasMoreTokens()) {
                     st = stt.nextToken().trim().toUpperCase();
                     if(st.startsWith("GROUPS") || st.startsWith("LOADS") || st.startsWith("ELEMENTS") || st.startsWith("CONTROLS") || st.startsWith("TRACKERS") || st.startsWith("MATERIALS")  || st.indexOf("BOUNDARY_CONDITION")!=-1 || st.indexOf("RIGID_BODY")!=-1)break;
                     if(st.startsWith("#") || st.length()==0)continue;
         ...
         while (stt.hasMoreTokens()) {
             ...
             if(st.startsWith("ELEMENTS")){
                 ...
                 while (stt.hasMoreTokens()) {
                     ...
                     if(st.startsWith("GROUPS") || st.startsWith("NODES") || st.startsWith("CONTROLS") || st.startsWith("TRACKERS") || st.startsWith("MATERIALS")  || st.indexOf("BOUNDARY_CONDITION")!=-1 || st.indexOf("RIGID_BODY")!=-1 || st.indexOf("LOADS")!=-1)break;
                     StringTokenizer stt1 = new StringTokenizer(st,"[]");
                     String key = stt1.nextToken();
     ...
     block_one:
    	 if (inblock) {
             ...
             if (st.startsWith("NODES") || st.startsWith("GEOMETRY") || st.startsWith("GROUPS") || st.startsWith("LOADS") || st.startsWith("ELEMENTS") || st.startsWith("CONTROLS") || st.startsWith("TRACKERS") || st.startsWith("MATERIALS")  || st.indexOf("BOUNDARY_CONDITION")!=-1 || st.indexOf("RIGID_BODY")!=-1) {
                 inblock = false;
                 break block_one;
    		 }
     ...
     inblock = false;
     geom = new String();
     gtype = new Regex("^(?i) *GEOMETRY *OF *TYPE *(SURFBIL|SURFDIR|SURFFILL|SURFREV|SURFRUL) *$");
     ...
     // GROUPS
     Regex Group1 = new Regex("^(?i) *([0-9]+) *NAME *= *([a-zA-Z\\/.0-9_]*)");
     _Group ng;
     ...
     for (int i=0; i<2 ; i++) {
         ...
         while (stt.hasMoreTokens()) {
             ...
             if(st.startsWith("GROUPS")) inblock = true;
             if(st.startsWith("NODES") || st.startsWith("LOADS") || st.startsWith("ELEMENTS") || st.startsWith("CONTROLS") || st.startsWith("TRACKERS") || st.startsWith("MATERIALS")  || st.indexOf("BOUNDARY_CONDITION")!=-1 || st.indexOf("RIGID_BODY")!=-1) inblock=false;
             ...
             if(inblock)
                 if (Group1.search(st)) {
                     ...
                     if (i==0) 
                         ...
                         ng = (_Group)GRDB.get(Group1.stringMatched(1)); // Get group defined in first pass
                     
                     ng.readObject((i==0),st,NDB,EDB,GDB,GRDB);
                     
                     if (i==0) {
                         GRDB.put(ng.get_Id(), ng); // Key is Id defined in file
