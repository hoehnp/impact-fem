...
public class PreProcessor_Rotate extends JPanel {
  ...
  void jButton1_actionPerformed(ActionEvent e) {
    try{
      ...
      if(rb_x.isSelected()) m.xrot(Float.parseFloat(tfa.getText()));
      else if(rb_y.isSelected()) m.yrot(Float.parseFloat(tfa.getText()));
      else if(rb_z.isSelected()) m.zrot(Float.parseFloat(tfa.getText()));
      m.translate(Float.parseFloat(x1.getText()),Float.parseFloat(y1.getText()),Float.parseFloat(z1.getText()));
      J3D.transform3D(m);
