...
/**
 * This is the energy tracker     The tracker reads the energy from the node
 * and plots it.
 *
...
public class EnergyTracker extends Tracker {
        ...
        throws java.text.ParseException
    {
        ...
        // Assign a local reference to use at later stage when collecting node data
        ...
        while (i < param.length) {
            ...
            if (
                param[i].getw().toUpperCase().equals("TYPE") &&
    ...
    {
        if (
            ! print_internal && ! print_external && ! print_contact &&
            ! print_hourglass
        ) {
        ...
        throws IOException, IllegalArgumentException
    {
        ...
        case RESULT_HEADER:
            ...
            try {
                ...
                System.out.println(
                    "Error in creating the EnergyTracker file: " + filename
                );
                throw ioe;
            }
        ...
        case RESULT:
            ...
            try {
                ...
                System.out.println(
                    "Error in writing results to the EnergyTracker file: " +
                    filename
                );
                throw ioe;
            }
