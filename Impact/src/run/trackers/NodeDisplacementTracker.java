...
/**
 * This is the nodal displacement tracker The tracker reads the displacement of
	...
	public void print_Gid(int ctrl, double currtime) throws IOException,
		...
		case RESULT_HEADER:
			...
			try {
				...
				System.out
						.println("Error in creating the NodeDisplacementTracker file: "
								+ filename);
				throw ioe;
			}
		...
		case RESULT:
			...
			try {
				...
				System.out
						.println("Error in writing results to the NodeDisplacementTracker file: "
								+ filename);
				throw ioe;
			}
