...
/**
 * This is the nodal displacement tracker     The tracker reads the
 * displacement of a node in a specific direction and prints it  to a chosen
 ...
 */
public class NodeDisplacementTracker extends Tracker {
        ...
        throws IllegalArgumentException
    {
        ...
        if (print_x) {
            result = node.getX_pos() - node.getX_pos_orig();
        } else if (print_y) {
            result = node.getY_pos() - node.getY_pos_orig();
        } else {
            result = node.getZ_pos() - node.getZ_pos_orig();
        }
    }
        ...
        throws java.text.ParseException
    {
        ...
        while (i < param.length) {
            ...
            if (
                param[i].getw().toUpperCase().equals("NODE") &&
        ...
        throws IllegalArgumentException
    {
        if (! Nodes_are_set) {
            throw new IllegalArgumentException(
                "No nodes defined for this node displacement tracker: " +
                number
            );
        }
        ...
        if (! print_x && ! print_y && ! print_z) {
            throw new IllegalArgumentException(
                "No directions defined for this node displacement tracker: " +
                number
            );
        }
        ...
        if (! File_is_set) {
            throw new IllegalArgumentException(
                "No Filename defined for this node displacement tracker: " +
                number
            );
        }
    }
        ...
        throws IOException, IllegalArgumentException
    {
        ...
        case RESULT_HEADER:
            ...
            try {
                ...
                out = new String(
                        "# Impact node displacement tracker results from tracker number: " +
                        number + "\n"
                    );
                ...
                System.out.println(
                    "Error in creating the NodeDisplacementTracker file: " +
                    filename
                );
                throw ioe;
            }
        ...
        case RESULT:
            ...
            try {
                ...
                System.out.println(
                    "Error in writing results to the NodeDisplacementTracker file: " +
                    filename
                );
                throw ioe;
            }
        ...
        default:
            throw new IllegalArgumentException(
                "Unknown parameter for print_Gid in NodeDisplacementTracker number: " +
                number
            );
        }
    }
