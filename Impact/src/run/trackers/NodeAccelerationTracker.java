...
/**
 * This is the nodal acceleration tracker     The tracker reads the
 * acceleration of a node in a specific direction and prints it  to a chosen
 ...
 */
public class NodeAccelerationTracker extends Tracker {
        ...
        throws IllegalArgumentException
    {
        ...
        if (print_x) {
            result = node.getX_acc();
        } else if (print_y) {
            result = node.getY_acc();
        } else {
            result = node.getZ_acc();
        }
    }
        ...
        throws java.text.ParseException
    {
        ...
        while (i < param.length) {
            ...
            if (
                ...
                param[i + 1].getw().toUpperCase().equals("=") &&
                param[i + 2].getw().toUpperCase().equals("X")
            ) {
                print_x = true;
                i += 3;
            } else if (
                param[i].getw().toUpperCase().equals("DIRECTION") &&
                param[i + 1].getw().toUpperCase().equals("=") &&
                param[i + 2].getw().toUpperCase().equals("Y")
            ) {
                print_y = true;
                i += 3;
            } else if (
                param[i].getw().toUpperCase().equals("DIRECTION") &&
                param[i + 1].getw().toUpperCase().equals("=") &&
                param[i + 2].getw().toUpperCase().equals("Z")
            ) {
                print_z = true;
                i += 3;
            } else
        ...
        throws IllegalArgumentException
    {
        if (! Nodes_are_set) {
            throw new IllegalArgumentException(
                "No nodes defined for this node acceleration tracker: " +
                number
            );
        }
        ...
        if (! print_x && ! print_y && ! print_z) {
            throw new IllegalArgumentException(
                "No directions defined for this node acceleration tracker: " +
                number
            );
        }
        ...
        if (! File_is_set) {
            throw new IllegalArgumentException(
                "No Filename defined for this node acceleration tracker: " +
                number
            );
        }
    }
        ...
        throws IOException, IllegalArgumentException
    {
        ...
        case RESULT_HEADER:
            ...
            try {
                ...
                out = new String(
                        "# Impact node acceleration tracker results from tracker number: " +
                        number + "\n"
                    );
                ...
                System.out.println(
                    "Error in creating the NodeAccelerationTracker file: " +
                    filename
                );
                throw ioe;
            }
        ...
        case RESULT:
            ...
            try {
                ...
                System.out.println(
                    "Error in writing results to the NodeAccelerationTracker file: " +
                    filename
                );
                throw ioe;
            }
        ...
        default:
            throw new IllegalArgumentException(
                "Unknown parameter for print_Gid in NodeAccelerationTracker number: " +
                number
            );
        }
    }
