...
/**
 * This is the nodal acceleration tracker The tracker reads the acceleration of
 * a node in a specific direction and prints it to a chosen file as a function
 * of time.
 * 
	...
	public void print_Gid(int ctrl, double currtime) throws IOException,
		...
		case RESULT_HEADER:
			...
			try {
				...
				System.out
						.println("Error in creating the NodeAccelerationTracker file: "
								+ filename);
				throw ioe;
			}
		...
		case RESULT:
			...
			try {
				...
				System.out
						.println("Error in writing results to the NodeAccelerationTracker file: "
								+ filename);
				throw ioe;
			}
