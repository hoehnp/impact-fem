...
/**
 * This is an isoparametric elasto-plastic material law. The elastic Young's
 * modulus defines the stress-strain relation up to the yield stress. Above
 * yield stress, there are several options. The plastic behaviour can be
...
public class Elastoplastic extends Material {
	...
	/**
	 * Elastoplastic constructor comment.
	 */
	public Elastoplastic() {
		type = new String("ELASTOPLASTIC");
	...
	public void calculateStressOneDimensional(Jama.Matrix strain,
		...
		stress.set(0, 0, stress.get(0, 0)
				+ (youngs_modulus * dstrain.get(0, 0)));
