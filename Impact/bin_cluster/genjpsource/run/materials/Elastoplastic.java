...
public class Elastoplastic extends Material implements uka.patch.Patchable, uka.transport.Transportable {
   public void createPatch(Object _copy, uka.patch.PatchOutput po) throws java.io.IOException {
      Elastoplastic copy = (Elastoplastic)_copy;
   ...
   public static final uka.transport.TransportDescriptor TRANSPORT_DESCRIPTOR = new uka.transport.TransportDescriptor(){
      ...
      public boolean deepCloneReferences(Object orig, Object copy, uka.transport.DeepClone _helper) throws CloneNotSupportedException {
         ((Elastoplastic)copy).deepCloneReferences((Elastoplastic)orig, _helper);
         return false;
      }
      public Class getType() {
         return Elastoplastic.class;
      }
   };
   public uka.transport.TransportDescriptor getTransportDescriptor() {
      return TRANSPORT_DESCRIPTOR;
   }
   private static final int _SIZE = uka.transport.BasicIO.SIZEOF_boolean + uka.transport.BasicIO.SIZEOF_boolean + uka.transport.BasicIO.SIZEOF_boolean + uka.transport.BasicIO.SIZEOF_boolean + uka.transport.BasicIO.SIZEOF_boolean + uka.transport.BasicIO.SIZEOF_boolean + uka.transport.BasicIO.SIZEOF_boolean + uka.transport.BasicIO.SIZEOF_double + uka.transport.BasicIO.SIZEOF_double + uka.transport.BasicIO.SIZEOF_int + uka.transport.BasicIO.SIZEOF_int + uka.transport.BasicIO.SIZEOF_double;
   public Elastoplastic(uka.transport.UnmarshalStream _stream, int _id) throws java.io.IOException, ClassNotFoundException {
      super(_stream, _id);
   }
   public void unmarshal(uka.transport.UnmarshalStream _stream) throws java.io.IOException, ClassNotFoundException {
      ...
      _stream.request(Elastoplastic._SIZE);
      ...
      _pos += uka.transport.BasicIO.SIZEOF_double;
      _stream.accept(Elastoplastic._SIZE);
   ...
   public void marshal(uka.transport.MarshalStream _stream) throws java.io.IOException {
      ...
      _stream.reserve(Elastoplastic._SIZE);
      byte[] _buffer = _stream.getBuffer();
      int _pos = _stream.getPosition();
   ...
   public Elastoplastic(Elastoplastic _orig, int _id, uka.transport.DeepClone _helper) throws CloneNotSupportedException, java.io.IOException {
   ...
   public void deepCloneReferences(Elastoplastic _orig, uka.transport.DeepClone _helper) throws CloneNotSupportedException {
   ...
   public Elastoplastic() {
      super();
      this.type = new String("ELASTOPLASTIC");
   ...
   public void calculateStressOneDimensional(Jama.Matrix strain, Jama.Matrix dstrain, Jama.Matrix stress, double timestep) {
      ...
      stress.set(0, 0, stress.get(0, 0) + this.youngs_modulus * dstrain.get(0, 0));
