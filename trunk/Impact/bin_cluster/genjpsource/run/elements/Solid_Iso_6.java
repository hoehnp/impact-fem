...
public class Solid_Iso_6 extends Element implements uka.patch.Patchable, uka.transport.Transportable {
   public void createPatch(Object _copy, uka.patch.PatchOutput po) throws java.io.IOException {
      Solid_Iso_6 copy = (Solid_Iso_6)_copy;
   ...
   public static final uka.transport.TransportDescriptor TRANSPORT_DESCRIPTOR = new uka.transport.TransportDescriptor(){
      ...
      public boolean deepCloneReferences(Object orig, Object copy, uka.transport.DeepClone _helper) throws CloneNotSupportedException {
         ((Solid_Iso_6)copy).deepCloneReferences((Solid_Iso_6)orig, _helper);
         return false;
      }
      public Class getType() {
         return Solid_Iso_6.class;
      }
   };
   ...
   public Solid_Iso_6(uka.transport.UnmarshalStream _stream, int _id) throws java.io.IOException, ClassNotFoundException {
      super(_stream, _id);
   }
   public void unmarshal(uka.transport.UnmarshalStream _stream) throws java.io.IOException, ClassNotFoundException {
      ...
      _stream.request(Solid_Iso_6._SIZE);
      ...
      _stream.accept(Solid_Iso_6._SIZE);
   ...
   public void marshal(uka.transport.MarshalStream _stream) throws java.io.IOException {
      ...
      _stream.reserve(Solid_Iso_6._SIZE);
      byte[] _buffer = _stream.getBuffer();
      int _pos = _stream.getPosition();
   ...
   public Solid_Iso_6(Solid_Iso_6 _orig, int _id, uka.transport.DeepClone _helper) throws CloneNotSupportedException, java.io.IOException {
   ...
   public void deepCloneReferences(Solid_Iso_6 _orig, uka.transport.DeepClone _helper) throws CloneNotSupportedException {
   ...
   public Solid_Iso_6() {
      super();
      this.type = new String("SOLID_ISO_6");
      int i;
   ...
   public void assembleMassMatrix() throws IllegalArgumentException {
      ...
      calculateD(0, 0, 0);
      this.J[0] = this.D.times(this.M);
      total_mass = this.material[0].getDensity() * this.J[0].det() * 8;
      if (total_mass <= 0) {
