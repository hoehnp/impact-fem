...
2/11/06     Jonas Forssell    Adopted to suit Impact
...
public class GoldenSection extends Object {
	...
	public static double minimize(double a, double b, SingleFunction minclass,
			double tol) {
