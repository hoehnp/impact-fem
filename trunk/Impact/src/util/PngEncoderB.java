...
/**
 * PngEncoderB takes a Java BufferedImage object and creates a byte string which
 * can be saved as a PNG file. The encoder will accept BufferedImages with
 * eight-bit samples or 4-byte ARGB samples.
 * 
 * <p>
 * There is also code to handle 4-byte samples returned as one int per pixel,
 * but that has not been tested.
 * </p>
 * 
 * <p>
 * Thanks to Jay Denny at KeyPoint Software
 * <code>http://www.keypoint.com/</code> who let me develop this code on company
 * time.
 * </p>
 * 
 * <p>
 ...
 * 
 *          CHANGES: -------- 19-Sep-2003 : Fix for platforms using EBCDIC
 *          (contributed by Paulo Soares); 19-Oct-2003 : Change private fields
 *          to protected fields so that PngEncoderB can inherit them (JDE) Fixed
 *          bug with calculation of nRows Added modifications for unsigned short
 *          images (contributed by Christian at xpogen.com)
 */
