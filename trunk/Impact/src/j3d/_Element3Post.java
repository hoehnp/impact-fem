...
public class _Element3Post extends _Element implements Serializable{
  ...
  public _Element3Post(_Point p1, _Point p2, _Point p3){
    this(p1.x,p1.y,p1.z,p2.x,p2.y,p2.z,p3.x,p3.y,p3.z,null,Color.black);
  }
  public _Element3Post(float xx1, float yy1, float zz1, float xx2, float yy2, float zz2, float xx3, float yy3, float zz3, Color cont){
    this(xx1, yy1, zz1, xx2, yy2, zz2, xx3, yy3, zz3, null, cont);
  }
  public _Element3Post(float xx1, float yy1, float zz1, float xx2, float yy2, float zz2, float xx3, float yy3, float zz3){
    this(xx1, yy1, zz1, xx2, yy2, zz2, xx3, yy3, zz3, null, Color.black);
  }
  public _Element3Post(float xx1, float yy1, float zz1, float xx2, float yy2, float zz2, float xx3, float yy3, float zz3, Paint f, Color cont){
    x1=xx1;
    x2=xx2;
    x3=xx3;
    y1=yy1;
  ...
  public _Element3Post(float xx1, float yy1, float zz1, Color c1, float xx2, float yy2, float zz2, Color c2, float xx3, float yy3, float zz3, Color c3, Color cont){
    this(xx1,yy1,zz1,c1,xx2,yy2,zz2,c2,xx3,yy3,zz3,c3,null,cont);
  }
  public _Element3Post(float xx1, float yy1, float zz1, Color c1, float xx2, float yy2, float zz2, Color c2, float xx3, float yy3, float zz3, Color c3, Color c4, Color cont){
    x1=xx1;
    x2=xx2;
    x3=xx3;
    y1=yy1;
  ...
  public Object[] get_Array(Canvas3D j3d){
    arr = new Object[1];
    if(gradient[0]==null)arr[0]=new shpTriangle(x1,y1,z1,x2,y2,z2,x3,y3,z3,selected ? j3d.SELECTCOLOR : fill,contur);
    else if(gradient[3]!=null)if(selected)arr[0]=new shpTriangle(x1,y1,z1,x2,y2,z2,x3,y3,z3,j3d.SELECTCOLOR,contur); else arr[0]=new shpTriangle(x1,y1,z1,gradient[0],x2,y2,z2,gradient[1],x3,y3,z3,gradient[2],gradient[3],contur);
    else if(selected)arr[0]=new shpTriangle(x1,y1,z1,x2,y2,z2,x3,y3,z3,j3d.SELECTCOLOR,contur); else arr[0]=new shpTriangle(x1,y1,z1,gradient[0],x2,y2,z2,gradient[1],x3,y3,z3,gradient[2],contur);
  ...
  public String toString(){ return "Triangle ID="+Id;}
