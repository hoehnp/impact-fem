...
public class NodeForceTracker extends Tracker {
        ...
        throws java.text.ParseException
    {
        ...
        for (j = 5; j < param.length; j++) {
        	nodelist.add(
				super.findNode(
                	(int)param[j].getn(), globalnodelist
                )
            );
       	}
        ...
        throws IllegalArgumentException
    {
        ...
        if (! print_x && ! print_y && ! print_z) {
            throw new IllegalArgumentException(
                "No directions defined for this node force tracker: " + number
            );
        }

        if (! File_is_set) {
            throw new IllegalArgumentException(
                "No Filename defined for this node force tracker: " + number
            );
        }
    }
        ...
        throws IOException, IllegalArgumentException
    {
        ...
        case RESULT_HEADER:
            ...
            try {
                ...
                System.out.println(
                    "Error in creating the NodeForceTracker file: " + filename
                );
                throw ioe;
            }
        ...
        case RESULT:
            ...
            try {
                ...
                System.out.println(
                    "Error in writing results to the NodeForceTracker file: " +
                    filename
                );
                throw ioe;
            }
