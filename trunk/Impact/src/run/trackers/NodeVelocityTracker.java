...
/**
 * This is the nodal velocity tracker     The tracker reads the acceleration of
 * a node in a specific direction and prints it  to a chosen file as a
 * function of time.
 *
        ...
        throws IllegalArgumentException
    {
        if (! Nodes_are_set) {
            throw new IllegalArgumentException(
                "No nodes defined for this node velocity tracker: " + number
            );
        }
        ...
        throws IOException, IllegalArgumentException
    {
        ...
        case RESULT_HEADER:
            ...
            try {
                ...
                System.out.println(
                    "Error in creating the NodeVelocityTracker file: " +
                    filename
                );
                throw ioe;
            }
        ...
        case RESULT:
            ...
            try {
                ...
                System.out.println(
                    "Error in writing results to the NodeVelocityTracker file: " +
                    filename
                );
                throw ioe;
            }
