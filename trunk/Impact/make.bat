...
javac -target 1.5 -cp .;..\lib\jogl.jar;..\lib\gluegen-rt.jar;..\lib\patbinfree153.jar;..\lib_j3d\j3dcore.jar;..\lib_j3d\j3dutils.jar;..\lib_j3d\vecmath.jar;..\lib\LogDB.jar;..\lib\mysql-connector-java-5.1.11-bin.jar -O -d ..\bin run\*.java gui\*.java 
pause
